...
def trusted_list_api():
    trusted_list = {
        "schemaVersion": "1.0",
        "ecosystem": "talao-wallet-network",
        "lastUpdated": "2025-07-15T12:00:00Z",
        "entities": [
            {
                "id": "https://talao.co/issuer/grlvzckofy",
                "name": "Talao Issuer Test 10",
                "type": "issuer",
                "postalAddress": {
                    "streetAddress": "112 rue des Tuileries",
                    "locality": "St Ouen Marchefroy",
                    "postalCode": "28260",
                    "countryName": "FR"
                },
                "rootCertificates": [

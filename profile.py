...
from profiles import digital_credential_marketplace, talao_issuer_vc_sd_jwt_oidc4vci_15, dc_sd_jwt_vc_final, final_all_formats
...
profile = {
    ...
    "FINAL": dc_sd_jwt_vc_final.FINAL,
    "FINAL_ALL_FORMATS": final_all_formats.FINAL,
    "EBSI-V3": {
        "oidc4vciDraft": "10",
        "siopv2Draft": "12",
        "oidc4vpDraft": "13",
    ...
    "BASELINE": {  # DIIP V3.0
        ...
        "siopv2_prefix": "openid-vc://",
        "oidc4vp_prefix": "openid-vc://",
        "credentials_types_supported": ["IdentityCredential",  "Pid", "EmployeeBadge", "AdminBadge", "LegalRepresentativeBadge", "ManagerBadge",],
        "credential_configurations_supported": {
            "EmployeeBadge": {
                "format": "vc+sd-jwt",

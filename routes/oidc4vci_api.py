...
def oidc_issuer_landing_page(issuer_id, stream_id, red, mode):
    ...
    #elif issuer_id in [
    #    "mslmgnysdh", # emailpass and phone pass
    #    "acnliwayop",
    #    "lpiqylqrrs",
    #"]:
...
def issuer_token(issuer_id, red, mode):
    ...
    if client_authentication_method == 'client_attestation':
        try:
            ...
            return Response(**manage_error('invalid_request', 'Headres is notr correct for client attestation', red, mode, request=request))
...
def clean_jwt_vc_json(credential):
    ...
    with contextlib.suppress(Exception):
        ...
        del vc['vc']['issued']
        del vc['vc']['id']
        del vc['vc']['issuanceDate']
        del vc['vc']['credentialSubject']['id']
        del vc['vc']['expirationDate']
        del vc['vc']['validFrom']
